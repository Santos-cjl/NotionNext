...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Junliang Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A current college student majoring in Mathematical Finance, specializing in the field of financial risk control.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.junliangchen.cn', // 网站地址
